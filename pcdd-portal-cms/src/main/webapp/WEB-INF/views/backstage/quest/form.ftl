	    ...
	    <form class="form-horizontal sh-validate" id="form">
		  <div class="form-group">
		    <label  class="col-sm-3 control-label">标题</label>
		      <div class="col-sm-6">
			    <input type="text" disabled="disabled" maxLength="100" class="form-control" id="title" name="title" data-bind="textinput:model.formEntity.title" 
			    placeholder="请输入标题">
			  </div>
		  </div>
		  
		  <div class="form-group">
		    <label  class="col-sm-3 control-label">内容<span class="form-required">*</span></label>
		      <div class="col-sm-6">
