	    ...
	    <form class="form-horizontal sh-validate" id="form">
	     <div class="form-group">
		    <label for="firstname" class="col-sm-3 control-label center-block">游戏类型</label>
		      <div class="col-sm-7">
			    <select disabled="disabled" required class="form-control" id="gameType" name="gameType" data-bind="value:model.formEntity.gameType,event:{change:getAreaTypeByGameType}">
			    	<option value="">请选择游戏类型</option>
			    	<option value="1">北京28</option>
