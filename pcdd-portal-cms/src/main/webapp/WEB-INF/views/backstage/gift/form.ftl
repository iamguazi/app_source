	    ...
	    <form class="form-horizontal sh-validate" id="form">
	      ...
	      <div class="form-group">
		    <label  class="col-sm-3 control-label">礼品价格:</label>
		      <div class="col-sm-7">
			    <input type="text"  maxLength="30" class="form-control" id="giftPoint" name="giftPoint" data-bind="textinput:model.formEntity.giftPoint" 
			    placeholder="请输入礼品价格">
			  </div>
		  </div>
		  ...
		  <div class="form-group">
		    <label  class="col-sm-3 control-label">序号:</label>
		      <div class="col-sm-7">
			    <input type="text" required maxLength="10" class="form-control" id="giftOrder" name = "giftOrder" data-bind="textinput:model.formEntity.giftOrder"
			       placeholder="请输入序号">
			  </div>
		  </div>
         ...
         <div class="form-group">
		  ...
		  <div class="form-group">
		    <label for="lastname" class="col-sm-3 control-label">礼物图片</label>
			  <div class="col-sm-7">
				<div class="pic" >
