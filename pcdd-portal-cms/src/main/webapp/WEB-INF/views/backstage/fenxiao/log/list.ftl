...
<html>
  ...
  <body>
  	<input type="hidden" id="queryUrl"  value="<@full_path path='backstage/userFenxiaoLog/?act=QUERY' />"  />
  	<input type="hidden" id="deleteUrl"  value="<@full_path path='backstage/userFenxiaoLog/?act=DELETE' />"  />
  	<input type="hidden" id="saveUrl"  value="<@full_path path='backstage/userFenxiaoLog/?act=SAVE' />"  />
  	...
  	<input type="hidden" id="fullPath"  value="<@full_path path='' />"  />
       ...
       <div class="container" style="width:100%;">
		 ...
		 <div class="row">
	          ...
	          <ul class="breadcrumb">
	            <li><a href="javascript:void(0);">分销管理</a> <span class="divider">/</span></li>
					...
					<table class="table table-bordered table-hover">
						...
						<tbody data-bind="foreach: {data: model.dataList, as: 'item'}, visible: model.dataList().length" >
							<tr data-bind="css : { evenTr: $index()%2==1 }">
								...
								<td data-bind="text: $root.fmt.currency(item.fenxiaoPoint,{places: 2,symbol: '',thousand: ','})" ></td>
...
<script type="text/javascript" src="<@full_path path='js/backstage/fenxiao/log/service.js'/>" ></script>	
<script type="text/javascript" src="<@full_path path='js/backstage/fenxiao/log/list.js'/>" ></script>	
  </body>
</html>
