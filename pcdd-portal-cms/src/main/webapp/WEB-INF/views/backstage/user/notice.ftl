<!-- 新增或修改页 s-->
<div id="noticeModal" class="modal fade" style="width: 100%;" tabindex="-1" aria-labelledby="noticeLabel" aria-hidden="true">
        ...
        <form class="form-horizontal" id="noticeForm">
          <div class="form-group">
            <label  class="col-sm-2 control-label">标题<span class="form-required">*</span></label>
              <div class="col-sm-6">
                <input type="text" maxLength="300" required class="form-control" id="title" name="title" data-bind="textinput:model.notice.title" 
                placeholder="请输入标题">
              </div>
          </div>
          ...
          <div class="form-group">
            <label  class="col-sm-2 control-label">内容<span class="form-required">*</span></label>
              <div class="col-sm-9">
                <textarea rows="5" style="max-width:100%;"  maxLength="500" class="form-control" id="content" name = "content" data-bind="textinput:model.formEntity.content" >
                </textarea>
              </div>
          </div>
        </form>
       ...
       <div class="modal-footer" style="border-top:0;">
         <div class="row"  >
           ...
           <div class="col-lg-2 col-md-2 col-xs-2 col-sm-2" >
             <button type="button" class="btn btn-primary center-block" data-bind="click:$root.noticeForm.bind($root)">
