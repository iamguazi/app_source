...
public class UserInfoDetailsController  extends NoValidController {
	...
	public Object handleRequest(Map<String, Object> requestArgument)
			throws ApiException {
		String userInfoId=requestArgument.get("user_id").toString();
		
		

		return userInfoDao. getUserInfoById(Integer.parseInt(userInfoId));
	}
}
