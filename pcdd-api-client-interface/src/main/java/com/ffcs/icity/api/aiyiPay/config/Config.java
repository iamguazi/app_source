...
public class Config {
    ...
    public static String url = "http://mch.iyibank.com/cashier/Home";//提交地址
    public static String callback_url = "http://27.155.120.197:50001/pcdd-wap/views/module/index/huidiao.html";//前台通知页面(用于展示，没有数据交互)
    public static String notify_url = "http://www.pcgg28.com/pcdd-api-client-interface/aiyi/recv";//后台通知页面(用于支付结果接收)
    ...
    public static String getErPayUrl(String orderNo, String fee, String payType, String mch_id, String Key) {
        ...
        LOGGER.info("aiyizhifu url is {}", url + testurl.toString());
...
//        System.out.println(url+testurl.toString());
        LOGGER.info("aiyizhifu result is {},use {} ms", strJson, Long.valueOf(System.currentTimeMillis() - t1));
        return strJson;
