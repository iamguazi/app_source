...
public class DelRoomUserInfoController  extends NoValidController {
	...
	public Object handleRequest(Map<String, Object> requestArgument)
		...
		ObjectNode addUserToGroupNode =new EasemobChatGroups().deleteUserFromGroup(addToChatgroupid, toAddUsername);
		System.out.println(addUserToGroupNode.toString());
		
		RoomUserInfo roomUser = roomUserInfoDao.getRoomUserInfoByParams(roomUserInfo);
		if(roomUser!=null){
			roomUserInfoDao.deleteRoomUserInfo(roomUser.getId());
		}
		return "ok";
	}
}
