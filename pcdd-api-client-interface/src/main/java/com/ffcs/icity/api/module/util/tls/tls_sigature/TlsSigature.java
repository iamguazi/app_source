package com.ffcs.icity.api.module.util.tls.tls_sigature;
...
import com.ffcs.icity.api.module.util.tls.base64_url.base64_url;
...
public class TlsSigature {
	 ...
	 * @return
	 */
	public   String getUserSig(int skdAppid,String userId,String privStr,String pubStr) {
		
		try{			
		 
            GenTLSSignatureResult result = GenTLSSignatureEx(skdAppid, userId, privStr);
            ...
            // check signature
            CheckTLSSignatureResult checkResult = CheckTLSSignatureEx(result.urlSig, skdAppid, userId, pubStr);
