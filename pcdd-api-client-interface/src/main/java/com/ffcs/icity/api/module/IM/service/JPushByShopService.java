...
@Service
public class JPushByShopService {
	@Value("${shopPushAppKey}")
    private  String appKey;
    @Value("${shopPushApiPassword}")
	...
	public void sentContentByTagAnd(Set<String> tags, String pushContent,boolean apnsFalg){
		...
		try {
			jPushClient.sendPush(buildPushObject_ios_tagAnd_alertWithExtrasAndMessage(tags, pushContent,apnsFalg));
		} catch (APIConnectionException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (APIRequestException e) {
 ...
 */
	...
	public static PushPayload buildPushObject_ios_tagAnd_alertWithExtrasAndMessage(Set<String> tags, String pushContent,boolean apnsFalg) {
