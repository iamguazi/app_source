...
public class UserLevelDetailsController  extends NoValidController {
	...
	public Object handleRequest(Map<String, Object> requestArgument)
			throws ApiException {
		String userLevelId=requestArgument.get("userLevel_id").toString();
		
		

		return userLevelDao. getUserLevelById(Integer.parseInt(userLevelId));
	}
}
