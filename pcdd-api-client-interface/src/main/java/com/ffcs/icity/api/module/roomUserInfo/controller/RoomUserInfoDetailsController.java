...
public class RoomUserInfoDetailsController  extends NoValidController {
	...
	public Object handleRequest(Map<String, Object> requestArgument)
			throws ApiException {
		String roomUserInfoId=requestArgument.get("roomUserInfo_id").toString();
		
		

		return roomUserInfoDao. getRoomUserInfoById(Integer.parseInt(roomUserInfoId));
	}
}
