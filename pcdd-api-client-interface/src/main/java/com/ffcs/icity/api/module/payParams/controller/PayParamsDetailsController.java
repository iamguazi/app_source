...
public class PayParamsDetailsController  extends NoValidController {
	...
	public Object handleRequest(Map<String, Object> requestArgument)
			throws ApiException {
		String payParamsId=requestArgument.get("payParams_id").toString();
		
		

		return payParamsDao. getPayParamsById(Integer.parseInt(payParamsId));
	}
}
